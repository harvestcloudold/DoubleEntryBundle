...
/**
 * ExchangeProductPostingFeeInvoiceJournal
 *
 ...
 * @ORM\Entity
 */
class ExchangeProductPostingFeeInvoiceJournal extends ProductPostingFeeInvoiceJournal
{
    /**
     * post()
     *
    ...
    public function post()
    {
        ...
        $salesPosting->setAccount($this->getInvoice()->getExchange()->getProfile()->getSalesAccount());
        ...
        $arPosting->setAccount($this->getInvoice()->getExchange()->getProfile()->getAccountsReceivableAccount());
